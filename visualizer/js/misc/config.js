let Config = new function() {
    ...
    //              turquoise      yellow      red        pink      indigo    blue        lightblue  green
    //this.colors = ["#FFFFFF", "#FFFF00", "#FF0000", "#FF66FF", "#333399", "#0000FF", "#33CCFF", "#00FF00"];
    this.colors = ["#45D2C4", "#EEE4B2", "#F0E6B9","#ECCB42","#F2A61F", "#C9392E","#B72820", "#B72820"];
    this.delays = [0, 1, 2, 3, 4, 5, 6, 7];

    // particle config
    this.maxParticleCount = 1000; // particle count at 1080p
    ...
    this.particleSizeMin = 10;
    this.particleSizeMax = 25;
