let GuiWrapper = new function() {
    ...
    this.setTitle  = function(artist, title) {
        ...
        let nowPlaying = document.getElementById("now-playing-text");
        if (nowPlaying) {
            let displayArtist = artist || "Artiste inconnu";
            let displayTitle = title || "Titre inconnu";
            nowPlaying.innerText = displayArtist + " — " + displayTitle;
        }
    }
