let Background = new function() {
    ...
    this.loadVideoFile = function(file) {
    ...
    this.loadImageFile = function(file) {
        ...
        showImages();
        setBackground(imageObjectUrl, imageObjectUrl);
    }

    this.playVideo = function() {
        if (videoElement && usingVideo) {
            videoElement.play().catch(function() {});
        }
    }
    ...
    let hideImagesForVideo = function() {
        document.getElementById("bgimg1").style.display = "none";
        document.getElementById("bgimg2").style.display = "none";
